...
void main() {
  ...
  group('Pruebas para Insertar Verde', () {
    ...
    test('Debe regresar true siempre', () {
      expect(puedeInsertarV([], 5), isTrue);
      expect(puedeInsertarV([1, 2, 3], 4), isTrue);
      expect(puedeInsertarV([1, 2, 3, 4], 4), isTrue);
      expect(puedeInsertarV([4, 4, 4, 4], 5), isTrue);
      expect(puedeInsertarV([1, 1, 1, 1], 1), isTrue);
    });
